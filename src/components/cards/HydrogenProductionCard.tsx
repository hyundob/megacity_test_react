        ...
        <div className="card p-4">
            <div className="flex items-center gap-2 mb-4">
                ...
                <div className="flex-1">
                    <h2 className="text-base font-bold text-gray-800">수소 생산량</h2>
                    <p className="text-xs text-gray-500">실시간 생산 현황</p>
                </div>
                <div className="text-xs bg-cyan-100 text-cyan-700 border border-cyan-200 rounded-full px-2 py-0.5 font-medium">
                    {totalItems} 활성
                </div>
            </div>
            ...
            <div className="mb-4 flex items-center justify-center p-2 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-gray-500" />
                    <span className="text-xs text-gray-500">응답 시간:</span>
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-100">
                    ...
                    <div>
                        ...
                        <div className="text-base font-bold text-blue-700">{Math.round(lastItem.hgenCapa).toLocaleString()} KG</div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 p-3 bg-green-50 rounded-lg border border-green-100">
                    ...
                    <div>
                        ...
                        <div className="text-base font-bold text-green-700">{Math.round(lastItem.hgenProd).toLocaleString()} KG</div>
                    </div>
                </div>
            </div>
        </div>
