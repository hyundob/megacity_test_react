        ...
        <div className="space-y-4">
            ...
            <div className="bg-black/5 dark:bg-white/5 rounded-xl p-4 border border-black/10 dark:border-white/10">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                        <h3 className="text-base font-bold text-slate-900 dark:text-slate-100">{selectedRegion?.name || '제주시'} 실황 (기상청)</h3>
                    </div>
                </div>

                <div className="grid grid-cols-5 gap-3">
                    <div className="bg-red-500/10 rounded-xl p-4 border border-red-500/20 flex flex-col items-center justify-center text-center min-h-[100px]">
                    ...
                    <div className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/20 flex flex-col items-center justify-center text-center min-h-[100px]">
                    ...
                    <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/20 flex flex-col items-center justify-center text-center min-h-[100px]">
                        ...
                        <div className="text-base font-bold text-blue-700 dark:text-blue-300 flex flex-col items-center gap-0.5">
                    ...
                    <div className="bg-violet-500/10 rounded-xl p-4 border border-violet-500/20 flex flex-col items-center justify-center text-center min-h-[100px]">
                        ...
                        <div className="text-sm font-bold text-violet-700 dark:text-violet-300">{ptyText ?? (pty !== null && pty !== undefined ? String(pty) : '없음')}</div>
                    </div>

                    <div className="bg-black/5 dark:bg-white/5 rounded-xl p-4 border border-black/10 dark:border-white/10 flex flex-col items-center justify-center text-center min-h-[100px]">
                        <div className="w-10 h-10 bg-black/8 dark:bg-white/10 rounded-lg flex items-center justify-center mb-2">
                ...
                {!tempC && !windMs && !windDir && !pty && (
                    <div className="mt-4 p-3 bg-yellow-500/10 rounded-lg border border-yellow-500/20 text-center">
                        <div className="text-xs text-yellow-700 dark:text-yellow-400 font-medium">지도를 클릭하여 지역을 선택하면 기상 정보가 표시됩니다.</div>
                    </div>
                )}
            </div>
        </div>
