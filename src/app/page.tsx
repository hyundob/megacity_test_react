    ...
    return (
        <div className="p-4">
            ...
            <div className="bg-gray-100 rounded shadow p-4 flex items-center justify-start gap-6 mb-4">
                <div>⏱ 마지막 업데이트: <strong>{d.lastUpdated || '로딩 중...'}</strong></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <SystemStatusCard
                    latApi={d.latApi} latDb={d.latDb} latPredict={d.latPredict}
                    healthApi={d.healthApi} healthDb={d.healthDb} healthPredict={d.healthPredict}
                />
